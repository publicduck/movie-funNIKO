...
@Repository // stateless is replaced by Repository
public class MoviesBean {

    @PersistenceContext() // PersistenceContext need no uniName now
    ...
    @Transactional // insert Methods should be transactional, because they change the state of a db....
